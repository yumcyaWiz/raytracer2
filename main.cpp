...
int main(int argc, char** argv) {
    ...
    Camera *cam = new ThinLensCamera(camPos, camForward, 2.0f, 1.0f, Point3(0, 0, 1), 8.0f);
    ...
    Transform t2 = translate(Vec3(0, 0, 0))*rotateX(M_PI/2)*rotateZ(M_PI/3);
    ...
    objs->add(new Disk(&t2, &t2_inv, new Diffuse(0.9f), new Mono(RGB(1.0f, 0.5f, 0.0f)), 0.0f, 1.4f, 1.2f, 2*M_PI));
